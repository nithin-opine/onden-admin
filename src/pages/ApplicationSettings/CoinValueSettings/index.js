...
const columns = [
  ...
  },
  {
    ...
    text: "Default Coin value",
    sort: true,
  },
  {
    dataField: "credited",
    text: "Coin Credited for each session",
    sort: true,
  },
  {
    dataField: "minbalance",
    text: "Minimum Coin balance teacher",
    sort: true,
  },
  {
    dataField: "view",
...
class CoinvalueSettings extends Component {
  constructor(props) {
    super(props)
    this.state = {
      isModelOpen: false,
...
export default CoinvalueSettings
