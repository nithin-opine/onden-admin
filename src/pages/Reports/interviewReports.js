...
class InterviewReports extends Component {
  constructor(props) {
    super(props)
  ...
  getReport() {
    ...
    let url =
      ...
      this.state.end_date
    let resp = apiGet(url)
    resp.then(resp =>{ console.log(resp.response.data.data); updateData(resp.response.data.data)})
  }
    ...
    return (
      <React.Fragment>
        <div className="page-content">
          <MetaTags>
            <title>Onden | Interview Reports</title>
          </MetaTags>
          <Container fluid>
