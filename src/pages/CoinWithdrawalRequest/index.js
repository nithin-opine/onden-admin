...
class CoinWithDrawalRequest extends Component {
  constructor(props) {
    super(props)
    this.state = {
      apiData: [],
  ...
  componentDidMount() {
    let url = BaseUrl.apiUrl.baseUrl + "api/admin/teacher/payment_requests"
    let resp = apiGet(url)
    ...
    resp.then(resp => {
      ...
      resp.response.data.data.forEach((value, index) => {
        ...
        rows.push({
          ...
          coinsrequested: value.coinsToBeTransferred,
          coinbalance: value.coinsInHand,
          exchangeratio: value.coinExchangeValue,
          salarybenefit: value.salaryBenefit,
...
export default CoinWithDrawalRequest
